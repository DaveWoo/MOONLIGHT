...
namespace XinYu.SOMDiff
{
    ...
    public class SOMDiff
    {
        ...
        private static Stack<string> originalTypeStack = null;
        private static Stack<string> changedTypeStack = null;
        ...
        public static void Initial()
        {
            ...
            originalTypeStack = new Stack<string>();
            changedTypeStack = new Stack<string>();
        }
