    ...
    public partial class Analyze
    {
        ...
        private List<IParserObject> ProcessTypeChangeUpdate(MismatchedPair somDiffResult, List<IParserObject> originalObject, List<IParserObject> changedObject, List<IParserObject> destinationObject)
        {
            ...
            try
            {
                ...
                Queue<string> xPathSource = ConvertToQueue(entryListSource);
                ...
                bool isExist = IsExistElement(xPathSource, result.Element as CsElement);
                ...
                Queue<string> xPathChanged = ConvertToQueue(entryListChanged);
                ...
                isExist = IsExistElement(xPathChanged, result.Element as CsElement);
        ...
        private bool IsExistElement(Queue<string> xPath, CsElement csElement)
        {
            bool isExist = false;
            ...
            foreach (var item in csElement.ChildElements)
            {
                ...
                {
                    this.IsExistElement(xPath, item);
                }
