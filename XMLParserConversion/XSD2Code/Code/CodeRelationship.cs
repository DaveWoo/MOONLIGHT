namespace XinYu.XSD2Code
{
    ...
    public partial class Analyze
    {
        ...
        public void Initialize(string slnPath)
        {
            ...
            if (XinYu.XSD2Code.Common.ContextXMLParserList == null)
            {
                XinYu.XSD2Code.Common.ContextXMLParserList = new List<IParserObject>();
            }
            XinYu.XSD2Code.Common.AppliedRuleList = new List<AppliedRule>();
        }
